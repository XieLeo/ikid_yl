...
int main(int argc, char** argv)
{
    ...
    FILE* fp = NULL;
	char ch[500];
	char filename[] = "/home/nvidia/ikid_ws2/specialgait_data.txt";
    fp = fopen(filename, "w");
	if (fp == NULL)
	{
		exit(0);
   ...
   while (ros::ok()) 
   {
        ...
        while (ros::ok())
        {
            ...
            //cout << "[out] read(connfd, buf, sizeof(buf))" << endl;
            ...
            if(n!=0 && n!=-1){
                ...
                if(token_str == "start_write_gait_txt"){
                    txt_src = "/home/nvidia/ikid_ws2/specialGaitFile/";
