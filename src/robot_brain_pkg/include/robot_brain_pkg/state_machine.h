...
const char head_pos_file_path[] = "/home/nvidia/ikid_ws2/src/robot_brain_pkg/data/head_pos_angle.txt";
...
public:
    ...
    // // 读取配置文件
    void readConfig() {
        const char kick_football_distance_trigger_file_path[] = "/home/nvidia/ikid_ws2/src/robot_brain_pkg/data/kick_football_distance_trigger.txt";
    ...
    void readReadyWalktimeAngle() {
        fin.open("/home/nvidia/ikid_ws2/src/robot_brain_pkg/data/ready_walktime_angle.txt", std::ios::in);
    ...
    // 读取该机器人是否是前锋
    void readIsForward() {
        fin.open("/home/nvidia/ikid_ws2/src/robot_brain_pkg/data/is_forward.txt", std::ios::in);
        fin >> is_forward;
