...
set(MSG_I_FLAGS "-Iikid_motion_control:/home/nvidia/ikid_ws2/src/ikid_motion_control/msg;-Istd_msgs:/opt/ros/melodic/share/std_msgs/cmake/../msg")
...
get_filename_component(_filename "/home/nvidia/ikid_ws2/src/ikid_motion_control/msg/cmd_walk.msg" NAME_WE)
add_custom_target(_ikid_motion_control_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "ikid_motion_control" "/home/nvidia/ikid_ws2/src/ikid_motion_control/msg/cmd_walk.msg" ""
)

get_filename_component(_filename "/home/nvidia/ikid_ws2/src/ikid_motion_control/msg/robot_joint.msg" NAME_WE)
add_custom_target(_ikid_motion_control_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "ikid_motion_control" "/home/nvidia/ikid_ws2/src/ikid_motion_control/msg/robot_joint.msg" ""
)
...
if(genpy_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/ikid_motion_control)
  install(CODE "execute_process(COMMAND \"/usr/bin/python2\" -m compileall \"${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/ikid_motion_control\")")
  # install generated code
  install(
