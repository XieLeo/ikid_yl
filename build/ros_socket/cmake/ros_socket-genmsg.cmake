...
message(STATUS "ros_socket: 3 messages, 0 services")

set(MSG_I_FLAGS "-Iros_socket:/home/nvidia/ikid_ws2/src/ros_socket/msg;-Istd_msgs:/opt/ros/melodic/share/std_msgs/cmake/../msg")
...
get_filename_component(_filename "/home/nvidia/ikid_ws2/src/ros_socket/msg/robot_head_pos.msg" NAME_WE)
add_custom_target(_ros_socket_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "ros_socket" "/home/nvidia/ikid_ws2/src/ros_socket/msg/robot_head_pos.msg" ""
)

get_filename_component(_filename "/home/nvidia/ikid_ws2/src/ros_socket/msg/robot_joint.msg" NAME_WE)
add_custom_target(_ros_socket_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "ros_socket" "/home/nvidia/ikid_ws2/src/ros_socket/msg/robot_joint.msg" ""
)

get_filename_component(_filename "/home/nvidia/ikid_ws2/src/ros_socket/msg/cmd_walk.msg" NAME_WE)
add_custom_target(_ros_socket_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "ros_socket" "/home/nvidia/ikid_ws2/src/ros_socket/msg/cmd_walk.msg" ""
)
