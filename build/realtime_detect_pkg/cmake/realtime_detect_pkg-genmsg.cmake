...
message(STATUS "realtime_detect_pkg: 2 messages, 0 services")

set(MSG_I_FLAGS "-Irealtime_detect_pkg:/home/nvidia/ikid_ws2/src/realtime_detect_pkg/msg;-Istd_msgs:/opt/ros/melodic/share/std_msgs/cmake/../msg")
...
get_filename_component(_filename "/home/nvidia/ikid_ws2/src/realtime_detect_pkg/msg/image_points.msg" NAME_WE)
add_custom_target(_realtime_detect_pkg_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "realtime_detect_pkg" "/home/nvidia/ikid_ws2/src/realtime_detect_pkg/msg/image_points.msg" ""
)

get_filename_component(_filename "/home/nvidia/ikid_ws2/src/realtime_detect_pkg/msg/all_image_points.msg" NAME_WE)
add_custom_target(_realtime_detect_pkg_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "realtime_detect_pkg" "/home/nvidia/ikid_ws2/src/realtime_detect_pkg/msg/all_image_points.msg" "realtime_detect_pkg/image_points"
)
