...
(cl:defmethod cl:initialize-instance :after ((m <robot_head_pos>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'robot_head_pos)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name worker_brain_pkg-msg:<robot_head_pos> is deprecated: use worker_brain_pkg-msg:robot_head_pos instead.")))

(cl:ensure-generic-function 'neck_rotation_theta-val :lambda-list '(m))
(cl:defmethod neck_rotation_theta-val ((m <robot_head_pos>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader worker_brain_pkg-msg:neck_rotation_theta-val is deprecated.  Use worker_brain_pkg-msg:neck_rotation_theta instead.")
...
(cl:defmethod neck_front_swing_theta-val ((m <robot_head_pos>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader worker_brain_pkg-msg:neck_front_swing_theta-val is deprecated.  Use worker_brain_pkg-msg:neck_front_swing_theta instead.")
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<robot_head_pos>)))
  ...
  "worker_brain_pkg/robot_head_pos")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'robot_head_pos)))
  "Returns string type for a message object of type 'robot_head_pos"
  "worker_brain_pkg/robot_head_pos")
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<robot_head_pos>)))
  ...
  (cl:format cl:nil "# 发送前转为弧度~%# 颈旋转：80-（-80）度 左-右~%# 颈前摆：0-90度 上-下~%float64 neck_rotation_theta  # 颈旋转关节角度~%float64 neck_front_swing_theta # 颈前摆关节角度~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'robot_head_pos)))
  "Returns full string definition for message of type 'robot_head_pos"
  (cl:format cl:nil "# 发送前转为弧度~%# 颈旋转：80-（-80）度 左-右~%# 颈前摆：0-90度 上-下~%float64 neck_rotation_theta  # 颈旋转关节角度~%float64 neck_front_swing_theta # 颈前摆关节角度~%~%"))
