...
(cl:defmethod cl:initialize-instance :after ((m <cmd_walk>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'cmd_walk)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name robot_brain_pkg-msg:<cmd_walk> is deprecated: use robot_brain_pkg-msg:cmd_walk instead.")))

(cl:ensure-generic-function 'sx-val :lambda-list '(m))
(cl:defmethod sx-val ((m <cmd_walk>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader robot_brain_pkg-msg:sx-val is deprecated.  Use robot_brain_pkg-msg:sx instead.")
  (sx m))

(cl:ensure-generic-function 'sy-val :lambda-list '(m))
(cl:defmethod sy-val ((m <cmd_walk>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader robot_brain_pkg-msg:sy-val is deprecated.  Use robot_brain_pkg-msg:sy instead.")
  (sy m))

(cl:ensure-generic-function 'var_theta-val :lambda-list '(m))
(cl:defmethod var_theta-val ((m <cmd_walk>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader robot_brain_pkg-msg:var_theta-val is deprecated.  Use robot_brain_pkg-msg:var_theta instead.")
  (var_theta m))

(cl:ensure-generic-function 'walk_with_ball-val :lambda-list '(m))
(cl:defmethod walk_with_ball-val ((m <cmd_walk>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader robot_brain_pkg-msg:walk_with_ball-val is deprecated.  Use robot_brain_pkg-msg:walk_with_ball instead.")
  (walk_with_ball m))

(cl:ensure-generic-function 'stop_walk-val :lambda-list '(m))
(cl:defmethod stop_walk-val ((m <cmd_walk>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader robot_brain_pkg-msg:stop_walk-val is deprecated.  Use robot_brain_pkg-msg:stop_walk instead.")
  (stop_walk m))
