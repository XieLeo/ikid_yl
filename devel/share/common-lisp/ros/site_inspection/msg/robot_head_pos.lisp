...
(cl:defmethod cl:initialize-instance :after ((m <robot_head_pos>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'robot_head_pos)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name site_inspection-msg:<robot_head_pos> is deprecated: use site_inspection-msg:robot_head_pos instead.")))

(cl:ensure-generic-function 'neck_rotation_theta-val :lambda-list '(m))
(cl:defmethod neck_rotation_theta-val ((m <robot_head_pos>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader site_inspection-msg:neck_rotation_theta-val is deprecated.  Use site_inspection-msg:neck_rotation_theta instead.")
...
(cl:defmethod neck_front_swing_theta-val ((m <robot_head_pos>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader site_inspection-msg:neck_front_swing_theta-val is deprecated.  Use site_inspection-msg:neck_front_swing_theta instead.")
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<robot_head_pos>)))
  ...
  "site_inspection/robot_head_pos")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'robot_head_pos)))
  "Returns string type for a message object of type 'robot_head_pos"
  "site_inspection/robot_head_pos")
