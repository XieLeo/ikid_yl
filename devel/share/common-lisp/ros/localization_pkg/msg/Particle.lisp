...
(cl:defmethod cl:initialize-instance :after ((m <Particle>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Particle)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name localization_pkg-msg:<Particle> is deprecated: use localization_pkg-msg:Particle instead.")))
...
(cl:defmethod weight-val ((m <Particle>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader localization_pkg-msg:weight-val is deprecated.  Use localization_pkg-msg:weight instead.")
  (weight m))
