...
(cl:defmethod cl:initialize-instance :after ((m <robot_joint>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'robot_joint)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name ikid_motion_control-msg:<robot_joint> is deprecated: use ikid_motion_control-msg:robot_joint instead.")))

(cl:ensure-generic-function 'joint-val :lambda-list '(m))
(cl:defmethod joint-val ((m <robot_joint>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ikid_motion_control-msg:joint-val is deprecated.  Use ikid_motion_control-msg:joint instead.")
  (joint m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<robot_joint>)))
  ...
  "ikid_motion_control/robot_joint")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'robot_joint)))
  "Returns string type for a message object of type 'robot_joint"
  "ikid_motion_control/robot_joint")
