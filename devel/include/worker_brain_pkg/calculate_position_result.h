// Generated by gencpp from file worker_brain_pkg/calculate_position_result.msg
// DO NOT EDIT!


#ifndef WORKER_BRAIN_PKG_MESSAGE_CALCULATE_POSITION_RESULT_H
#define WORKER_BRAIN_PKG_MESSAGE_CALCULATE_POSITION_RESULT_H
...
struct calculate_position_result_
{
  ...
  typedef boost::shared_ptr< ::worker_brain_pkg::calculate_position_result_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::worker_brain_pkg::calculate_position_result_<ContainerAllocator> const> ConstPtr;

}; // struct calculate_position_result_

typedef ::worker_brain_pkg::calculate_position_result_<std::allocator<void> > calculate_position_result;

typedef boost::shared_ptr< ::worker_brain_pkg::calculate_position_result > calculate_position_resultPtr;
typedef boost::shared_ptr< ::worker_brain_pkg::calculate_position_result const> calculate_position_resultConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::worker_brain_pkg::calculate_position_result_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::worker_brain_pkg::calculate_position_result_<ContainerAllocator> >::stream(s, "", v);
return s;
}


template<typename ContainerAllocator1, typename ContainerAllocator2>
bool operator==(const ::worker_brain_pkg::calculate_position_result_<ContainerAllocator1> & lhs, const ::worker_brain_pkg::calculate_position_result_<ContainerAllocator2> & rhs)
{
...
template <class ContainerAllocator>
struct IsFixedSize< ::worker_brain_pkg::calculate_position_result_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::worker_brain_pkg::calculate_position_result_<ContainerAllocator> const>
  : FalseType
  { };

template <class ContainerAllocator>
struct IsMessage< ::worker_brain_pkg::calculate_position_result_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::worker_brain_pkg::calculate_position_result_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::worker_brain_pkg::calculate_position_result_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct HasHeader< ::worker_brain_pkg::calculate_position_result_<ContainerAllocator> const>
  : FalseType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::worker_brain_pkg::calculate_position_result_<ContainerAllocator> >
{
  ...
  static const char* value(const ::worker_brain_pkg::calculate_position_result_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0xe9ec4e75c98d04e4ULL;
  static const uint64_t static_value2 = 0xa675f9b544fcf13dULL;
};

template<class ContainerAllocator>
struct DataType< ::worker_brain_pkg::calculate_position_result_<ContainerAllocator> >
{
  static const char* value()
  {
...
template<class ContainerAllocator>
struct Definition< ::worker_brain_pkg::calculate_position_result_<ContainerAllocator> >
{
  static const char* value()
  {
    return "# 目标检测像素坐标点\n"
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::worker_brain_pkg::calculate_position_result_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::worker_brain_pkg::calculate_position_result_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::worker_brain_pkg::calculate_position_result_<ContainerAllocator>& v)
  {
...
#endif // WORKER_BRAIN_PKG_MESSAGE_CALCULATE_POSITION_RESULT_H
